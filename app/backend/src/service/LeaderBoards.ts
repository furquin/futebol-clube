...
export default class LeaderBoardService {
  ...
  static async DataMatchHome(team: ITeams, matches: IMtaches) {
  ...
  static async DataMatchAway(team: ITeams, matches: IMtaches) {
  ...
  static async leaderboards() {
    ...
    return teams.map((team) => {
      matches.forEach((match) => this.DataMatchHome(team, match));
      matches.forEach((match) => this.DataMatchAway(team, match));
